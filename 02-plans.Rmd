...
The R package is publishable by itself as an **application note paper**.
...
**identification of optimal training data size**, in the sense that we can use various methods to derive a node (biomarker) set for the training data. Eirini and Kath are into this as well.

Goal is to have **a total of 2 papers (one with me as main author)** from the search for biomarkers and drug 
