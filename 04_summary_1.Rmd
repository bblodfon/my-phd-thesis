...
:::{.quote}
```{=html}
<blockquote style='border:none'>&ldquo;While the future is unknowable, the winds always blow in the direction of human progress.&rdquo; </br><strong>Barack Obama</strong></blockquote>
```
:::
...
```{=html}
<p style='text-align:center;'><i>Of course, not everything is perfect...</i><br>
<img src='https://media.giphy.com/media/xUOxflndliXhidwlyw/giphy.gif' style='display: block; margin-left: auto; margin-right: auto;' width='50%' onError="this.style.display='none'"></img>
<br>
```
