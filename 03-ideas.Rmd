...
**Optimization problem**: find β (inhibitor weight, different per target boolean function) that makes a system of boolean threshold function (a model that is) exhibit a specific FP.
