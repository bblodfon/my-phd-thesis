...
On eye-balling/curating synergy: What is a ~~mountain~~?
...
It is used pretty much in any synergy-related paper I have seen but nobody has actually defined or named it.
A characteristic example is *eye-balling* synergies from dose-response curves, like we did in our group for the SINTEF screen data [@Flobak2019] and the output is [this online doc](http://tiny.cc/sintefGS).
...
*Curate* a sample of drug combination datasets regarding their synergy assesement - a consortium paper, with partners like Sanger, O'Neill, etc.
So a large synergy curation effort. 
This correlates with Martin's idea of **creating curation guidelines for drug combination screening**.
