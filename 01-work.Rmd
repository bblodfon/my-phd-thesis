...
We called them UBD's: *Unified Biological Dictionaries*.
See [UBD GitHub organisation page](https://github.com/UniBioDicts).
See [manuscript](http://tiny.cc/ubds).
...
THe UBD's translate various online data resources to a unified (VSM-enabled) dictionary data format.
Sources include BioPortal, UniProt, Ensembl, EnsemblGenomes, RNACentral, ComplexPortal among others. 
