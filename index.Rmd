...
<div id="html-intro" class="section level1 unnumbered">
  ...
  <p class='green-box'>
    The HTML text has additional stuff like the above to make your reading experience more enjoyable and interesting! You can download from the <strong>top toolbar</strong> the static PDF that also includes the papers if you'd like. <br><br> Btw, feel free to use the code the made this GitBook if you want! Enjoy (^-^)
  </p>
</div>
```
