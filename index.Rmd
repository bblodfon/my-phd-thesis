...
<p> Welcome to my e-thesis! Here's is a reward for you that chose this format to read my thesis: </p>

<img src='https://media.giphy.com/media/dXckBa1HDG86RqUh19/giphy.gif' width='50%'></img>

<p>
You may see some more of these around the HTML text to make your reading experience more enjoyable! You can download from the <strong>top toolbar</strong> the more serious PDF that also includes the primary papers  if you like. 
<br><br>
Btw, feel free to use the code if you like! Enjoy (^-^) 
</p>
</div>
```
