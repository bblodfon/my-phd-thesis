...
<div id="html-intro" class="section level1 unnumbered">
  ...
  <p>
    You may see some more of these around the HTML text to make your reading experience more enjoyable! You can download from the <strong>top toolbar</strong> the more serious PDF that also includes the papers if you'd like. <br><br> Btw, feel free to use the code if you like! Enjoy (^-^)
  </p>
</div>
```
