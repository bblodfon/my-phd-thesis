...
For example, we verified across many analyses ^[See repository `gitsbe-model-analysis` [here](#misc-links)] that the ERK node of the CASCADE signaling network was particularly overexpressed in the models that predicted most of the gold standard synergies in the AGS cell line from the reference drug combination dataset.
