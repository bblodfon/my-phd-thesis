...
```{=html}
<blockquote>&ldquo;Mankind invented a system to cope with the fact that we are so intrinsically lousy at manipulating numbers. It's called the graph.&rdquo; ~ Charlie Munger</blockquote>
```
